...
HTTP是`HyperText Transfer Protocol`的缩写，翻译为超文本传输协议，它是基于TCP协议之上的一种请求-响应协议。
...
下载练习：[使用HttpClient](https://gitee.com/liaoxuefeng/learn-java/blob/master/practices/Java教程/150.网络编程.1255945371526048/60.HTTP编程.1319099982413858/network-http.zip?utm_source=blog_lxf)
