...
下载练习：[使用maven-shade-plugin创建可执行jar](https://gitee.com/liaoxuefeng/learn-java/blob/master/practices/Java教程/140.Maven基础.1255945359327200/40.使用插件.1309301217951777/maven-plugin.zip?utm_source=blog_lxf)
